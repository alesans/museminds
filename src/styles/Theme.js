...
const Breakpoint = css`
  @media ${(props) => props.theme.maxbp.xs} {
    ...
    grid-gap: ${(props) => props.theme.grid.gap[props.xsgap] || props.xsgap};
  ...
  @media ${(props) => props.theme.maxbp.sm} {
    ...
    grid-gap: ${(props) => props.theme.grid.gap[props.smgap] || props.smgap};
  ...
  @media ${(props) => props.theme.maxbp.md} {
    ...
    grid-gap: ${(props) => props.theme.grid.gap[props.mdgap] || props.mdgap};
  ...
  @media ${(props) => props.theme.maxbp.lg} {
    ...
    grid-gap: ${(props) => props.theme.grid.gap[props.lggap] || props.lggap};
  ...
  @media ${(props) => props.theme.maxbp.xl} {
    ...
    grid-gap: ${(props) => props.theme.grid.gap[props.xlgap] || props.xlgap};
